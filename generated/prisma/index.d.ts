...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"userId" | "username" | "password" | "email" | "createdAt", ExtArgs["result"]["user"]>
  ...
  export type StreamOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"streamId" | "userId" | "title" | "category" | "description" | "thumbnailUrl" | "status" | "startedAt" | "endedAt" | "createdAt" | "updatedAt", ExtArgs["result"]["stream"]>
  ...
  export interface StreamDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const streamWithStreamIdOnly = await prisma.stream.findMany({ select: { streamId: true } })
     * 
     */
  ...
  interface StreamFieldRefs {
    readonly streamId: FieldRef<"Stream", 'Int'>
    readonly userId: FieldRef<"Stream", 'Int'>
    readonly title: FieldRef<"Stream", 'String'>
    readonly category: FieldRef<"Stream", 'Category'>
  ...
  /**
   * Reference to a field of type 'category.enum.ts'
   */
  ...
  export type StreamWhereInput = {
    ...
    streamId?: IntFilter<"Stream"> | number
    userId?: IntFilter<"Stream"> | number
    title?: StringFilter<"Stream"> | string
    category?: EnumCategoryFilter<"Stream"> | $Enums.Category
    ...
    startedAt?: DateTimeFilter<"Stream"> | Date | string
  ...
  export type StreamScalarWhereWithAggregatesInput = {
    ...
    streamId?: IntWithAggregatesFilter<"Stream"> | number
    userId?: IntWithAggregatesFilter<"Stream"> | number
    title?: StringWithAggregatesFilter<"Stream"> | string
    category?: EnumCategoryWithAggregatesFilter<"Stream"> | $Enums.Category
    ...
    startedAt?: DateTimeWithAggregatesFilter<"Stream"> | Date | string
  ...
  export type StreamUncheckedUpdateInput = {
    streamId?: IntFieldUpdateOperationsInput | number
    userId?: IntFieldUpdateOperationsInput | number
    title?: StringFieldUpdateOperationsInput | string
    category?: EnumCategoryFieldUpdateOperationsInput | $Enums.Category
    description?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type EnumStreamStatusFilter<$PrismaModel = never> = {
    ...
    in?: $Enums.StreamStatus[]
    notIn?: $Enums.StreamStatus[]
